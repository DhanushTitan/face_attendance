...
#         'last_attendance': datetime.now().strftime("%Y-%m-%d %H:%M:%S.%f")
#     })


# def store_attendance_history(student_id):
...
# #     if student:
# #         return render_template('student_detail.html', student=student, student_id=student_id)
# #     else:
